...
output_file('fl_covid-19_positivityrate.html')


# In[20]:


data=pd.read_json('https://covidtracking.com/api/v1/states/fl/daily.json')
...
df2.to_excel('C:\Shiven\Python\Projects\COVID-19\States\FL\df2.xlsx', index = False, header=True)


# In[34]:


g=figure(title="COVID-19 Positivity Rate in Florida (Shiven Patel)", x_axis_type='datetime')
