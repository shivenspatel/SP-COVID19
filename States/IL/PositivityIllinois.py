...
output_file('C:\\Shiven\\Python\\Projects\\COVID-19\\templates\\il_covid-19_positivityrate.html')


# In[2]:


data=pd.read_json('https://covidtracking.com/api/v1/states/il/daily.json')
...
df2.to_excel('C:\Shiven\Python\Projects\COVID-19\States\IL\df2.xlsx', index = False, header=True)


# In[14]:


g=figure(title="COVID-19 Positivity Rate in Illinois (Shiven Patel)", x_axis_type='datetime')
