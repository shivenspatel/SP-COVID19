...
output_file('ny_covid-19_positivityrate.html')


# In[20]:


data=pd.read_json('https://covidtracking.com/api/v1/states/ny/daily.json')
...
g=figure(title="COVID-19 Positivity Rate in New York (Shiven Patel)", x_axis_type='datetime')
